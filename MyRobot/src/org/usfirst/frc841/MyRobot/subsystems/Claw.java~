...
public class Claw extends Subsystem {
    ...
    private final Solenoid theSalute = RobotMap.clawTheSalute;
   ...
   public void setSalute(boolean set) {
	   this.theSalute.set(set);
   }
   ...
   public double getAngle() {
	  return (double) (elbow.getSensorCollection().getPulseWidthPosition()+this.offset+this.zero);
   }
   ...
   public void zeroElbow() {
	...
	//	   this.offset = 3700 - elbow.getSensorCollection().getPulseWidthPosition() -this.zero;
	   }
