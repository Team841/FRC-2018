...
public class OI {
    ...
    public JoystickButton moveClawDown;
    public JoystickButton moveClawUp;
    ...
    public OI() {
        ...
        spitOut = new JoystickButton(coPilot, 12);
        spitOut.whileHeld(new SetIntakes(2));
        clawOpen = new JoystickButton(coPilot, 5);
        ...
        SmartDashboard.putData("LeftScore", new LeftScore());
        SmartDashboard.putData("RightScore", new RightScore());
        SmartDashboard.putData("MiddleLeftAuto", new MiddleLeftAuto());
        SmartDashboard.putData("MiddleRightAuto", new MiddleRightAuto());
        ...
        SmartDashboard.putData("MoveClawDownManually", new MoveClawDownManually());
        SmartDashboard.putData("MoveClawUpManually", new MoveClawUpManually());
