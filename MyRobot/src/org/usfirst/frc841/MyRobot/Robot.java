...
public class Robot extends TimedRobot {
    ...
    public void autonomousInit() {
       	...
       	//ONLY IN THE CASE THAT 1 IS LEFT AND 2 IS RIGHT
       	else
       	{
       		//WE ARE ON THE LEFT AND THE GOAL IS ON THE LEFT
       		if((data.charAt(0)=='L') && (Robot.driveTrain.getAutoSelect()== 1)) {
       			//GO FORWARD AND DROP IT, this is because the parameter is true
       			chooser.addDefault("AutoForwardDropOrKeep", new AutoForwardDropOrKeep(true));
       		}
       		//WE ARE ON THE RIGHT AND THE GOAL IS ON THE RIGHT
       		else if((data.charAt(0)=='R') && (Robot.driveTrain.getAutoSelect()== 2)){
       			//GO FORWARD AND DROP IT
       			chooser.addDefault("AutoForwardDropOrKeep", new AutoForwardDropOrKeep(true));
       		}
       		//WE ARE IN FRONT OF THE WRONG GOAL, THAT MEANS THAT WE NEED ONLY TO GO FORWARD
       		else {
       			chooser.addDefault("AutoForwardDropOrKeep", new AutoForwardDropOrKeep(false));
