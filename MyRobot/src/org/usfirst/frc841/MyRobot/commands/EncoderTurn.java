...
public class EncoderTurn extends Command {
    ...
    public EncoderTurn(double distance, double power, boolean isLeft) {
	...
	protected void execute() {
		if (isLeft) {
			Robot.driveTrain.SetLeftRight(-power, -power);
		} else {
			Robot.driveTrain.SetLeftRight(power, power);
		}
    }
    ...
    protected boolean isFinished() {
        ...
        if (isLeft) {
        	return (right-left)*.5 > distance;
        } else {
        	return (left-right)*.5 > distance;
        }
    }
