 ...
 *
 */
public class PutClawInPixelIntakePosition extends CommandGroup {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public PutClawInPixelIntakePosition() {

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    	
    	addSequential(new UpdatePID(C.cl_p,C.cl_i,C.cl_d));
    	addSequential(new SetGrabber(true));
    	addSequential(new SetIntakes(C.intake_suck));
    	addSequential(new SetClawAngle(C.claw_dwn));
    	addSequential(new EngageAutoGrab());
